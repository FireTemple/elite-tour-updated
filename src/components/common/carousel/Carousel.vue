      ...
      <ul>
        ...
        <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
          ...
          <div class="tp-caption customin tp-resizeme rs-parallaxlevel-0" data-x="center" data-y="center"
               ...
               style="z-index: 12;"><a href='all_tours_list.html' class="button_intro">View tours</a> <a
            href='single_tour_with_gallery.html' class=" button_intro outline">Read more</a>
          </div>
        </li>
        <!-- SLIDE  -->
        <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"
